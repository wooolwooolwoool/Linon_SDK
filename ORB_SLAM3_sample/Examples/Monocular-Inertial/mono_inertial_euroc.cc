...
int main(int argc, char *argv[])
{
    ...
    for (seq = 0; seq<num_seq; seq++)
    {
        ...
        int buf_size = 1048576; //1024*1024
        ...
        for(int ni=0; ni<nImages[seq]; ni++, proccIm++)
        {
            ...
            while (true)
            {
                ...
                cout << "Failed " << ni << sizeof(data) << sizeof(data[0]) << endl;
            }
            if (ni%30 == 0){
                cout << "loaded " << ni << endl;
            }
    ...
    #endif
#endif
                int width = im.cols * imageScale * 2;
                int height = im.rows * imageScale * 2;
